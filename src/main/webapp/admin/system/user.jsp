...
<script>
var UrlConfig = {
	SysUserList: '<%=request.getContextPath() %>/sys/user/list',
	SysUserPage: '<%=request.getContextPath() %>/sys/user/page',
	SysUserAdd: '<%=request.getContextPath() %>/sys/user/add',
	SysUserUpdate: '<%=request.getContextPath() %>/sys/user/update',
	SysUserDelete: '<%=request.getContextPath() %>/sys/user/delete',
	SysUserResetPassword: '<%=request.getContextPath() %>/sys/user/resetPassword',
	
	SysRoleList: '<%=request.getContextPath() %>/sys/role/listNoRoot',
	SysGroupList: '<%=request.getContextPath() %>/sys/group/ownGroups'
};
