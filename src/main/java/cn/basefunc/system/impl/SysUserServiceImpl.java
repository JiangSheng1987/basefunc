...
import cn.basefunc.system.dao.SysUserDao;
import cn.basefunc.system.entity.SysUser;
import cn.basefunc.system.service.SysUserService;
...
public class SysUserServiceImpl implements SysUserService {
	...
	public void save(SysUser user) throws UserExistsException {
		...
		if (user.getPassword() == null || "".equals(user.getPassword())){
			user.setPassword(AppHelper.encryptPassword(AppHelper.DEFAULT_USER_PASSWORD));
		}
	...
	public void resetPassword(String userId) {
		this.updatePassword(userId, AppHelper.DEFAULT_USER_PASSWORD);
	}
